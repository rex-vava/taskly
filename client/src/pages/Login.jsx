  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-slate-100 p-4">
      <div className="card w-full max-w-md p-8">
        ...
        <p className="text-sm text-slate-500 text-center mb-6">Sign in to manage your tasks</p>

        {error && (
          <div className="bg-red-50 text-red-600 text-sm p-3 rounded-lg mb-4" onClick={() => dispatch(clearError())}>
            {error}
          </div>
        )}
